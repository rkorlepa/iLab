...
class n7kSwitch(Switch):
    ...
    def ascii_copy(self, db, switch_cons):
        ...
        if foundk==founds==1:
            db.update_images(self.switch_name, kick, sys)
        else:
        ...
        i = switch_cons.expect([defn.SWITCH_PROMPT,r'yes/no',pexpect.TIMEOUT, pexpect.EOF], 600)
        if i==0:
            pass
        if i==1:
    ...
    def copy_images_to_switch(self, log):
        ...
        if i==2:
            ...
            console.expect(defn.SWITCH_PROMPT, 120)
