	...
	create: function ( conf ) {
		...
		conf._input = $(
			'<div id="'+Editor.safeId( conf.id )+'">'+
				'<button class="inputButton" value="n7k">n7k</button>'+
				'<button class="inputButton" value="xbow">xbow</button>'+
				'<button class="inputButton" value="n3k">n3k</button>'+
				'<button class="inputButton" value="n5k">n5k</button>'+
				'<button class="inputButton" value="n6k">n6k</button>'+
				'<button class="inputButton" value="n9k">n9k</button>'+
				'<button class="inputButton" value="cat2k">cat2k</button>'+
				'<button class="inputButton" value="cat6k">cat6k</button>'+
				'<button class="inputButton" value="mds">mds</button>'+
				'<button class="inputButton" value="asr9k">asr9k</button>'+
			'</div>');
...
$(document).ready(function() {
	...
	var table = $('#switches').DataTable( {
		...
		columns: [
			...
			{ "data": "hold_testbed", "className": "editable"},
			{ "data": "sanity_type" },
			{ "data": "is_powered_on" },
			{ "data": "linecards" },
			{ "data": "user", "className": "editable"},
			{ "data": "manager" }
		],
		select: 
		{
